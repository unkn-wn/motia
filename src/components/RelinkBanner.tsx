...
const RelinkBanner: React.FC<Props> = ({ isLoading, onRelinkClick, fileInputRef, onFileSelected }) => (
  <div className="absolute top-3 left-1/2 -translate-x-1/2 z-50 px-3 py-2 rounded-md bg-amber-500/10 border border-amber-400/40 text-amber-200 text-sm flex items-center gap-3">
