...
const ProfileModal: React.FC<ProfileModalProps> = ({ open, onClose }) => {
	...
	return (
		<Modal open={open} onClose={onClose} title="Account">
			<button
				onClick={onClose}
				className="absolute top-3 right-3 text-neutral-400 hover:text-neutral-200 cursor-pointer"
			...
			<div className="space-y-3">
				...
				<div className="rounded-lg border border-neutral-800 bg-neutral-900/60 p-3">
					...
					{isAnon && <div className="mt-2 text-xs text-neutral-400">Create an account to keep your projects across devices.</div>}
				</div>
				...
				<div className="mt-4 text-center">
					<p className="text-[10px] text-neutral-500">
						...
						<a
							href="https://forms.gle/sLvaeHxYUxraApS78"
							target="_blank"
							rel="noreferrer"
